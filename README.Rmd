...
```
Note you can also provide an `sfc`/`sfg` object to the `filter_geom` argument to perform a spatial filter. Note that this is limited to only one object. See documentation for more (`?arc_select`).
