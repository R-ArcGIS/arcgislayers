...
::: callout-tip
An [`llms.txt`](https://r.esri.com/arcgislayers/llms.txt) file is available to provide context for LLMs when working with this package.
:::
...
- [Publishing Layers](https://developers.arcgis.com/r-bridge/layers/publishing-services/)
- [Editing Feature Services](http://developers.arcgis.com/r-bridge/editing/overview/)
